...
namespace oact
{
    ...
    using IActionRef = std::shared_ptr<IAction>;
    using Actions = std::vector<IActionRef>;
    ...
    public:
        ...
        void addAction(const IActionRef& pAction);
        void undo() override;
        void redo() override;
    ...
    public:
         ...
         * @sa onut::Action
         */
        void doAction(const IActionRef& pAction);
        ...
        bool canRedo() const;
        bool canUndo() const;
        IActionRef getRedo() const;
        IActionRef getUndo() const;
        void redo();
        void undo();
        void clear();
